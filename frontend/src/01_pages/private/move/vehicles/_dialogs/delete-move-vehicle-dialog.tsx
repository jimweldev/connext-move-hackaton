...
// Props
type DeleteMoveVehicleDialogProps = {
...
const DeleteMoveVehicleDialog = ({
  open,
  setOpen,
  refetch,
}: DeleteMoveVehicleDialogProps) => {
  // Zustand store
  ...
  const onSubmit = (e: React.FormEvent<HTMLFormElement>) => {
    ...
    toast.promise(
      mainInstance.delete(`/move/vehicles/${selectedMoveVehicle?.id}`),
      {
        loading: 'Loading...',
        success: () => {
          refetch();
      ...
      <DialogContent>
        <form onSubmit={onSubmit}>
          <DialogBody>
            ...
            {/* Modal title */}
            <h3 className="text-center text-xl">Delete Move Vehicle</h3>
            ...
            <h2 className="text-center text-2xl font-semibold">
              {selectedMoveVehicle?.vehicle_name}
            </h2>
          </DialogBody>
...
export default DeleteMoveVehicleDialog;
